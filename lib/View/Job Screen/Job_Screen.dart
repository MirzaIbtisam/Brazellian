...
class Job_Screen extends StatefulWidget {
  ...
  @override
  State<Job_Screen> createState() => Job_ScreenState();
}

class Job_ScreenState extends State<Job_Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child:  Obx((){
          switch(jobsVM.rxRequestStatus.value){
            case Status.LOADING:
              return const Center(child: CircularProgressIndicator());
            case Status.ERROR:
              if(jobsVM.error.value =='No internet'){
                  ...
                  CarouselSlider.builder(
                      ...
                      itemBuilder: (BuildContext context, int index, int realIndex) {
                        return Container(
                          ...
                          child: Image.network(
                            jobsVM.worksList.value!.Works![0].thumbnail,
                            fit: BoxFit.cover,
                          ),
                        );
                      },
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Align(
                          alignment: Alignment.topLeft,
                          child: Text(
                            "${jobsVM.worksList.value!.Works![0].title}",
                            style: TextStyle(
                                fontSize: 20,
                                color: Colors.white,
                                fontFamily: "Plus Jakarta Sans",
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              "${jobsVM.worksList.value!.Works![0].local}",
                              style: TextStyle(
                                  fontSize: 13,
                                  color: Colors.white,
                          ...
                          switch(jobsVM.rxRequestStatus.value){
                            ...
                            case Status.COMPLETED:
                              return ListView.builder(
                                  itemCount: jobsVM.worksList.value.Works!.length,
                                  itemBuilder: (context, index){
                                    return GridView.builder(
                                      physics: ScrollPhysics(),
                                      shrinkWrap: true,
                                      itemCount: jobsVM.worksList.value!.Works!.isNotEmpty&&jobsVM.worksList.value!.Works!.length<6?jobsVM.worksList.value!.Works!.length:6, // Replace with the actual item count
                                      ...
                                      itemBuilder: (BuildContext context, int index) {
                                        ...
                                        return InkWell(
                                          onTap: ()async{
                                            // Get.to( ()=> Detail(data: jobsVM.worksList.value!.Works![index],));
                                          },
                                          child: Multiple_Servicee(
                                              "assets/Event button.svg",
                                              "assets/Favorite (1).svg",
                                              jobsVM.worksList.value!.Works![index].thumbnail,
                                              "${jobsVM.worksList.value?.Works?[index].title}",
                                              "\$ 50,00",context),
                                        );
                                      },
                                    );
