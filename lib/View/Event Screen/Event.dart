                  ...
                  CarouselSlider.builder(
                      ...
                      itemBuilder: (BuildContext context, int index, int realIndex) {
                        return Container(
                          ...
                          child: Image.network(
                            eventsVM.eventsList.value!.events![0].thumbnail,
                            fit: BoxFit.cover,
                          ),
                        );
                      },
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Align(
                          alignment: Alignment.topLeft,
                          child: Text(
                            "${eventsVM.eventsList.value!.events![0].title}",
                            style: TextStyle(
                                fontSize: 20,
                                color: Colors.white,
                                fontFamily: "Plus Jakarta Sans",
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              "${eventsVM.eventsList.value!.events![0].local}",
                              style: TextStyle(
                                  fontSize: 13,
                                  color: Colors.white,
                              ...
                              return ListView.builder(
                                  ...
                                  itemBuilder: (context, index){
                                    return GridView.builder(
                                      physics: ScrollPhysics(),
                                      shrinkWrap: true,
                                      itemCount: eventsVM.eventsList.value!.events!.isNotEmpty&&eventsVM.eventsList.value!.events!.length<6?eventsVM.eventsList.value!.events!.length:6, // Replace with the actual item count
                                      ...
                                      itemBuilder: (BuildContext context, int index) {
                                        ...
                                        return InkWell(
                                          onTap: ()async{
                                            // Get.to( ()=> Detail(data: eventsVM.eventsList.value!.events![index],));
                                          },
                                          child: Multiple_Servicee(
                                              "assets/Event button.svg",
                                              "assets/Favorite (1).svg",
                                              eventsVM.eventsList.value!.events![index].thumbnail,
                                              "${eventsVM.eventsList.value?.events?[index].title}",
                                              "\$ 50,00",context),
                                        );
                                      },
                                    );
