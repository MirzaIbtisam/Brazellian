...
class House_CleaningState extends State<House_Cleaning> {
  ...
  int currentIndex = 0;
  final servicesVM = Get.put(ServiceViewModel()) ;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Obx((){
          switch(servicesVM.rxRequestStatus.value){
            case Status.LOADING:
              return const Center(child: CircularProgressIndicator());
            case Status.ERROR:
              if(servicesVM.error.value =='No internet'){
                return InterNetExceptionWidget(onPress: () {
                  servicesVM.refreshApi();
                },);
              }else {
                  ...
                  CarouselSlider.builder(
                      ...
                      itemBuilder: (BuildContext context, int index, int realIndex) {
                        return Container(
                          ...
                          child: Image.network(
                            servicesVM.servicesList.value!.Services![0].thumbnail,
                            fit: BoxFit.cover,
                          ),
                        );
                      },
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Align(
                          alignment: Alignment.topLeft,
                          child: Text(
                            "${servicesVM.servicesList.value!.Services![0].title}",
                            style: TextStyle(
                                fontSize: 20,
                                color: Colors.white,
                                fontFamily: "Plus Jakarta Sans",
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              "${servicesVM.servicesList.value!.Services![0].local}",
                              style: TextStyle(
                                  fontSize: 13,
                                  color: Colors.white,
                          ...
                          switch(servicesVM.rxRequestStatus.value){
                            ...
                            case Status.COMPLETED:
                              return ListView.builder(
                                  itemCount: servicesVM.servicesList.value.Services!.length,
                                  itemBuilder: (context, index){
                                    return GridView.builder(
                                      physics: ScrollPhysics(),
                                      shrinkWrap: true,
                                      itemCount: servicesVM.servicesList.value!.Services!.isNotEmpty&&servicesVM.servicesList.value!.Services!.length<6?servicesVM.servicesList.value!.Services!.length:6, // Replace with the actual item count
                                      ...
                                      itemBuilder: (BuildContext context, int index) {
                                        ...
                                        return InkWell(
                                          onTap: ()async{
                                            // Get.to( ()=> Detail(data: servicesVM.servicesList.value!.services![index],));
                                          },
                                          child: Multiple_Servicee(
                                              "assets/Event button.svg",
                                              "assets/Favorite (1).svg",
                                              servicesVM.servicesList.value!.Services![index].thumbnail,
                                              "${servicesVM.servicesList.value?.Services?[index].title}",
                                              "\$ 50,00",context),
                                        );
                                      },
                                    );
