...
class DetailsRealEstate extends StatefulWidget {
  const DetailsRealEstate({super.key});

  @override
  State<DetailsRealEstate> createState() => DetailsRealEstateState();
}

class DetailsRealEstateState extends State<DetailsRealEstate> {
  List<String> Imge = [
    "assets/Flag.svg",
