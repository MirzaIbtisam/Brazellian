...
class Detailing_Screen extends StatefulWidget {
  const Detailing_Screen({super.key});

  @override
  State<Detailing_Screen> createState() => Detailing_ScreenState();
}

class Detailing_ScreenState extends State<Detailing_Screen> {
  List<String> img = [
    "assets/picture.jpg",
