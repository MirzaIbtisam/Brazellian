import 'package:brazeellian_community/Screens/History/History.dart';
import 'package:brazeellian_community/Screens/Privacy/Privacy.dart';
import 'package:brazeellian_community/Screens/Question/Question.dart';
import 'package:brazeellian_community/Screens/Support/Support.dart';
              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                      border: Border.all(color: Color(0xffffd600), width: 2.5),
                  ...
                  child: Column(
                    children: [
                      ...
                      InkWell(
                          ...
                          child: drawer(
                              "assets/browser-web-windows.svg", "Manage Plan")),
                      SizedBox(height: 20),
                      InkWell(
                          onTap: () {
                            Get.to(Pin());
                      ...
                      InkWell(
                          ...
                          child: drawer("assets/Destaques.svg", "Highlights")),
                      SizedBox(height: 40),
                            ...
                            onPressed: () {
                              showDialog<String>(
                                ...
                                builder: (BuildContext context) => AlertDialog(
                                  shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(15)),
                                  title: SvgPicture.asset("assets/Logout.svg"),
                                  content: Padding(
                                    padding: const EdgeInsets.only(left: 30),
                                    child: Text(
