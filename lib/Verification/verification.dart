          ...
          child: Center(
            child: Column(
              children: [
                ...
                Text(
                  "Enter the code",
                  style: TextStyle(fontSize: 24, color: Color(0xff111111),fontWeight: FontWeight.w700),
                ),
                SizedBox(height: 15),
                Text(
                ...
                Text(
                  "example@gmail.com",
                  style: TextStyle(fontSize: 14, color: Color(0xff3A3A3A),fontWeight: FontWeight.w500),
                ),
                SizedBox(height: 30),
                Padding(
